<?php $__env->startSection('title', 'SlangDict'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <section class="flex flex-col items-center text-center mt-28 px-6 animate-fade">
        ...
        <form action="<?php echo e(route('slangs.search')); ?>" method="GET" class="w-full max-w-xl">
    ...
    <section class="mt-24 px-8">
        ...
        <div class="grid md:grid-cols-4 gap-6">
            ...
            <?php if(isset($slangs) && $slangs->count()): ?>
...
<?php echo $__env->make('layout.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\MCA2025\project\slang-app\resources\views/index.blade.php ENDPATH**/ ?>